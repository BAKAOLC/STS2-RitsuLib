...
public sealed record SecondaryResourceCounterGainFeedback
{
    ...
    public static SecondaryResourceCounterGainFeedback From(params SecondaryResourceCounterGainEffect[] effects)
    {
        ...
        return new SecondaryResourceCounterGainFeedback
        {
...
public static class SecondaryResourceCounterGainEffects
{
    ...
    {
        return new SecondaryResourceCounterIconBrightnessFlashEffect(brightnessFrom, brightnessTo, durationSeconds);
    }
    ...
    {
        return new SecondaryResourceCounterStarCounterLikeBurstEffect(color ?? new Color(0.77f, 0.93f, 1f),
            durationSeconds);
    }
        ...
        Vector2? scale = null)
    {
        ...
        return new SecondaryResourceCounterEnergyCounterLikeParticlesEffect(backScenePath, frontScenePath, offset,
            scale);
    }
        ...
        bool behindCounter = true)
    {
        ...
        return new SecondaryResourceCounterSceneBurstEffect(scenePath, offset, scale, behindCounter);
    }
}
...
public partial class NSecondaryResourceCounter : Control
{
    ...
    public override void _Ready()
    {
        ...
        _icon = new NSecondaryResourceIcon
        {
...
public partial class NSecondaryResourceIcon : Control
{
    ...
    public Rect2 GetRenderedTextureRect()
    {
        if (_texture?.Texture == null)
            return new Rect2(_style.IconOffset, _style.Size);
        ...
        if (textureSize.X <= 0f || textureSize.Y <= 0f || boxSize.X <= 0f || boxSize.Y <= 0f)
            return new Rect2(_style.IconOffset, boxSize);
        ...
        return new Rect2(_style.IconOffset + offset, renderedSize);
    }
...
internal sealed partial class NSecondaryResourceStarCounterLikeBurstVfx : Node2D
{
    ...
    private ParticleProcessMaterial CreateIconMaterial()
    {
        return new ParticleProcessMaterial
        {
            ...
            AngularVelocityCurve = CreateCurveTexture(
                new Vector2(0f, 326.461f),
                new Vector2(1f, 303.241f),
                minValue: 0f,
                maxValue: 360f),
            Gravity = Vector3.Zero,
            ScaleCurve = CreateCurveTexture(
                new Vector2(0f, ResolveParticleScale(IconStartSizeFactor)),
                new Vector2(0.75f, ResolveParticleScale(IconEndSizeFactor)),
                width: 128,
                minValue: 0f,
                maxValue: 4f),
            Color = _color,
            AlphaCurve = CreateCurveTexture(
                new Vector2(0.151685f, 1f),
                new Vector2(0.99999f, 0f),
                new Vector2(1f, 0f))
        };
    }
    ...
    private ParticleProcessMaterial CreateGlowMaterial()
    {
        return new ParticleProcessMaterial
        {
            ...
            Gravity = Vector3.Zero,
            ScaleCurve = CreateCurveTexture(
                new Vector2(0f, ResolveParticleScale(GlowStartSizeFactor)),
                new Vector2(1f, ResolveParticleScale(GlowEndSizeFactor)),
                width: 128),
            Color = _color with { A = 0.592157f },
            AlphaCurve = CreateCurveTexture(
                new Vector2(0.202247f, 1f),
                new Vector2(0.99999f, 0f),
                new Vector2(1f, 0f))
        };
    }
...
public static class SecondaryResourceHoverTipFactory
{
        ...
        int? maxAmount = null)
    {
        ...
        {
            ({ } titleLoc, { } descriptionLoc) => new HoverTip(titleLoc, descriptionLoc, icon),
