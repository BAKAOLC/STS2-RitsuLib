...
namespace STS2RitsuLib.Scaffolding.Content
{
    /// <summary>
    ///     <para xml:lang="en">
    ///         Provides a base <see cref="RelicModel" /> for mods with optional energy and keyword hover tips plus
    ///         relic asset replacements.
    ///     </para>
    ///     <para xml:lang="zh-CN">
    ///         为模组提供基础 <see cref="RelicModel" />，支持可选的能量与关键词悬浮提示以及遗物资源替换。
    ///     </para>
    /// </summary>
