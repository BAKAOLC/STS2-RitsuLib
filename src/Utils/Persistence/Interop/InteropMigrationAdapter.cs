...
{
    /// <summary>
    ///     <para xml:lang="en">Adapts an object that defines <c>FromVersion</c>, <c>ToVersion</c>, and <c>Migrate(JsonObject)</c> to <see cref="IMigration" /> without requiring its type to reference RitsuLib.</para>
    ///     <para xml:lang="zh-CN">将定义了 <c>FromVersion</c>、<c>ToVersion</c> 和 <c>Migrate(JsonObject)</c> 的对象适配为 <see cref="IMigration" />，而无需其类型引用 RitsuLib。</para>
    /// </summary>
    public sealed class InteropMigrationAdapter : IMigration
    {
        ...
        /// <summary>
        ///     <para xml:lang="en">Creates an adapter for an existing migration instance that defines the required version members and migration method.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Attempts to invoke a parameterless constructor for the migration type and wrap the resulting instance.</para>
