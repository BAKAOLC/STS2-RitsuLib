...
{
    /// <summary>
    ///     <para xml:lang="en">Per-mod facade for registering dynamic enum values without making the internal ID category segment public.</para>
    ...
    public sealed class ModDynamicEnumValueRegistry<TEnum> where TEnum : struct, Enum
    {
        ...
        /// <summary>
        ///     <para xml:lang="en">Registers a value owned by this registry's mod using the enum type's configured category segment.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Returns and records the deterministic value for the canonical owned ID without registering a definition.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Returns the registered value for the canonical owned ID, or computes it without failing on hash collisions or adding a minter reverse lookup.</para>
