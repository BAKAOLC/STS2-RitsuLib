...
{
    /// <summary>
    ///     <para xml:lang="en">Configures initial backend values, lifecycle ownership, throttling, and higher-level routing for a playback request.</para>
    ///     <para xml:lang="zh-CN">配置播放请求的初始后端值、生命周期归属、节流和高级路由。</para>
    /// </summary>
    public sealed class AudioPlaybackOptions
    {
        /// <summary>
        ///     <para xml:lang="en">Gets or initializes the numeric FMOD parameters applied when the selected playback path supports them.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Gets or initializes whether a newly created controllable handle requests a paused initial state.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Gets or initializes the playback cooldown in milliseconds; zero or a negative value disables throttling.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Gets or initializes the active manual token that overrides <see cref="Scope" /> for handle grouping and cleanup; closing or disposed tokens reject playback.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Gets or initializes whether Studio event-path one-shots use the game's native audio-manager route.</para>
        ///     <para xml:lang="zh-CN">获取或初始化 Studio 事件路径单次播放是否使用游戏原生音频管理器路径。</para>
        /// </summary>
        public bool UseVanillaRouting { get; init; } = true;

        /// <summary>
        ///     <para xml:lang="en">Gets or initializes whether Studio loop playback applies the game's <c>loop = 0</c> parameter convention.</para>
        ///     <para xml:lang="zh-CN">获取或初始化 Studio 循环播放是否应用游戏的 <c>loop = 0</c> 参数约定。</para>
        /// </summary>
        public bool UsesLoopParameter { get; init; } = true;

        /// <summary>
        ///     <para xml:lang="en">Gets or initializes the optional cooldown-group key; the source representation is used when absent.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Gets the configured read-only parameter dictionary, or the shared empty dictionary when none is configured.</para>
