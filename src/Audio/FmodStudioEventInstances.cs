...
{
    /// <summary>
    ///     <para xml:lang="en">Creates and controls FMOD Studio event or snapshot instances whose start, stop, and release lifecycle is managed explicitly.</para>
    ...
    public static class FmodStudioEventInstances
    {
        ...
        /// </param>
        /// <returns>
        ///     <para xml:lang="en">A typed handle around the valid instance, or null when the source is unsupported or creation fails.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Attempts to create a valid Studio event or snapshot instance from a path, honoring any registered path-to-GUID mapping.</para>
        ...
        /// </returns>
        /// <remarks>
        ///     <para xml:lang="en">When a mapping exists and its GUID is loaded, GUID creation is attempted first. Native path creation is used when the mapped GUID is unavailable or creation by GUID fails and the native path is present.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Probes the raw <c>FmodServer.check_event_path</c> result without treating a registered GUID mapping as proof that the native path exists.</para>
        ...
        /// </param>
        /// <returns>
        ///     <para xml:lang="en"><see langword="true" /> or <see langword="false" /> for a completed probe; null when invocation is unavailable or fails.</para>
        ///     <para xml:lang="zh-CN">探测完成时为 <see langword="true" /> 或 <see langword="false" />；调用不可用或失败时为 <see langword="null" />。</para>
        /// </returns>
        ...
        /// <summary>
        ///     <para xml:lang="en">Attempts to create a valid Studio event or snapshot instance from a normalized GUID, using the same add-on entry point as its editor tools.</para>
        ...
        /// </param>
        /// <returns>
        ///     <para xml:lang="en">The valid instance, or null when the GUID is blank, malformed, known to be absent, or cannot be created.</para>
        ...
        /// </param>
        /// <returns>
        ///     <para xml:lang="en"><see langword="true" /> when the method invocation completes; otherwise <see langword="false" />.</para>
        ...
        ///     <para xml:lang="en">Whether to use FMOD stop mode <c>0</c> (allow fade-out); <see langword="false" /> uses immediate mode <c>1</c>.</para>
        ...
        /// <summary>
        ///     <para xml:lang="en">Attempts to schedule native release for a valid instance, logging a missing method or invocation failure.</para>
