...
namespace STS2RitsuLib.Scaffolding.Characters.Patches
{
    ...
    /// <summary>
    ///     Patches character-select portrait path so mods can replace <c>CharacterSelectIconPath</c>.
    /// </summary>
    public class CharacterSelectIconPathPatch : IPatchMethod
    {
        ...
        /// <inheritdoc />
        public static string Description => "Allow mod characters to override CharacterModel.CharacterSelectIconPath";
        ...
        public static ModPatchTarget[] GetTargets()
        {
            return [new(typeof(CharacterModel), "get_CharacterSelectIconPath")];
        }
    ...
    /// <summary>
    ///     Patches locked character-select portrait path so mods can replace <c>CharacterSelectLockedIconPath</c>.
    /// </summary>
    public class CharacterSelectLockedIconPathPatch : IPatchMethod
    {
        ...
        public static string Description =>
            "Allow mod characters to override CharacterModel.CharacterSelectLockedIconPath";
        ...
        public static ModPatchTarget[] GetTargets()
        {
            return [new(typeof(CharacterModel), "get_CharacterSelectLockedIconPath")];
        }

        // ReSharper disable InconsistentNaming
        /// <summary>
        ///     Supplies <see cref="IModCharacterAssetOverrides.CustomCharacterSelectLockedIconPath" /> when the resource
        ///     exists.
        /// </summary>
        public static bool Prefix(CharacterModel __instance, ref string __result)
            // ReSharper restore InconsistentNaming
