...
namespace STS2RitsuLib.Models.Capabilities
{
    ...
    public interface IModelCapabilitySource
    {
        ...
        /// </summary>
        void BuildDefaultCapabilities(ModelCapabilityList components);
    }

    /// <summary>
    ///     Optional component merge behavior used by <see cref="ModelCapabilitySet.Apply" />.
    ///     <see cref="ModelCapabilitySet.Apply" /> 使用的可选组件合并行为。
    /// </summary>
    ...
    public interface IModelCapabilityCloneNotification
    {
        ...
        void AfterOwnerCloned(AbstractModel originalOwner, AbstractModel clonedOwner,
            IModelCapability originalComponent);
    }
