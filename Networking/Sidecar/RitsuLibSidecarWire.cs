...
namespace STS2RitsuLib.Networking.Sidecar
{
    ...
    public static class RitsuLibSidecarWire
    {
        ...
        /// <summary>ENet channel for best-effort sidecar traffic.</summary>
        ...
        /// </summary>
        public const int MinEnvelopeSize = MagicLength + 2 + 4 + 8 + 4 + 4;

        /// <summary>Wire format version written by <see cref="RitsuLibSidecar.CreateEnvelope" />.</summary>
        public const ushort CurrentWireFormatVersion = 1;

        /// <summary>Highest wire format this library accepts.</summary>
        public const ushort SupportedWireFormatVersionMax = 1;

        /// <summary>Maximum logical payload size (after gzip decompress).</summary>
        public const uint MaxPayloadBytes = 4 * 1024 * 1024;

        /// <summary>Maximum header extension segment length (generous margin for future header TLVs).</summary>
        public const uint MaxHeaderExtensionBytes = 64 * 1024;

        /// <summary>Packet prefix; <c>"STS2RitsuLib"u8</c>.</summary>
        public static ReadOnlySpan<byte> Magic => "STS2RitsuLib"u8;

        /// <summary>Returns true when <paramref name="packet" /> begins with <see cref="Magic" />.</summary>
