...
namespace STS2RitsuLib.Networking.Sidecar
{
    ...
    public static class RitsuLibSidecarOpcodes
    {
        ...
        /// <summary>Upper bound of the reserved range for fixed (non-hashed) framework / library opcodes.</summary>
        public const ulong FixedProtocolOpcodeMaxInclusive = 0xFFFF;

        /// <summary>Lower bound of opcodes returned by <see cref="For" /> (above the reserved range).</summary>
